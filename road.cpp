...
face_loc{faceLoc}, model_loc{modelLoc} {
    ...
    const vec4 objects[numobjects][4] = {
       //Grid where the buildings will be held
       {
        ...
        //horizontal road
        {
            vec4(-15, 15, 0.01 , 1), vec4(15, 15, 0.01, 1),
            vec4(15, 20, 0.01, 1), vec4(-15, 20, 0.01, 1),
        },

        //Bottom most road 1 - horizontal
        {
            vec4(-15, -5, 0.01, 1), vec4(15, -5, 0.01, 1),
            vec4(15, -9, 0.01, 1), vec4(-15, -9, 0.01, 1),
        },
        ...
        {
            vec4(-15, -5, 0.01 , 1), vec4(-19, -5, 0.01, 1),
            vec4(-19, 35, 0.01, 1), vec4(-15, 35, 0.01, 1),
        },
...
/*
        ...
        {
            vec4(-3, -5, 0.01 , 1), vec4(-6, -5, 0.01, 1),
            vec4(-6, 35, 0.01, 1), vec4(-3, 35, 0.01, 1),
        },*/
